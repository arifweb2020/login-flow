...
function ResetPasswordPage() {
    ...
    return (
        <MainContainer>
            ...
            {successMsg ? <SuccessMsgAlert msgText="your password is reset successfully" click={handleClose} /> : null}
            ...
            <FormContainer container >
                ...
                <Grid container mt={2}>
                    ...
                    <Grid sm={4}>
                        <Box>
                            <InputHedaing >Password<span style={{ color: 'red' }}>*</span></InputHedaing>
                            <input type="password" className="inputForm" value={password} maxlength="15" onChange={(e) => setPassword(e.target.value)} />
                        </Box>
                        <Box mt={3}>
                            <InputHedaing>Confirm Password<span style={{ color: 'red' }}>*</span></InputHedaing>
                            <input type="password" className="inputForm" value={confirmpassword} maxlength="15" onChange={(e) => setConfirmPassword(e.target.value)} />
                        </Box>
                        <Box mt={6}>
                            <SubmitStyledBtn>
                                <button className="btn btn-submit btn-active" onClick={handleSubmission}>Reset Password</button>
                            </SubmitStyledBtn>
                        </Box>
                    </Grid>
                </Grid>
